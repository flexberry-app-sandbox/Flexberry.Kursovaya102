...
namespace IIS.Kursovaya10
{
    ...
    [View("РасторжДоговораE", new string[] {
            "Дата as \'Дата\'",
            "Номер as \'Номер\'",
            "ДирОтдПоРабСКл as \'Дир отд по раб с кл\'",
            "ДирОтдПоРабСКл.id as \'Id\'",
            "Клиент as \'Клиент\'",
            "Клиент.Фамилия as \'Фамилия\'"}, Hidden=new string[] {
            "ДирОтдПоРабСКл.id",
            "Клиент.Фамилия"})]
    [MasterViewDefineAttribute("РасторжДоговораE", "ДирОтдПоРабСКл", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "id")]
    [MasterViewDefineAttribute("РасторжДоговораE", "Клиент", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Фамилия")]
    ...
    public class РасторжДоговора : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасторжДоговораE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасторжДоговораE", typeof(IIS.Kursovaya10.РасторжДоговора));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасторжДоговораL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасторжДоговораL", typeof(IIS.Kursovaya10.РасторжДоговора));
                }
            }
        }
    }
