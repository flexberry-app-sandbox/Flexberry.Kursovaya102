...
namespace IIS.Kursovaya10
{
    ...
    public class ДирОтдПоРабСКл : ICSSoft.STORMNET.DataObject
    {
        ...
        /// id.
        /// </summary>
        // *** Start programmer edit section *** (ДирОтдПоРабСКл.id CustomAttributes)

        // *** End programmer edit section *** (ДирОтдПоРабСКл.id CustomAttributes)
        [StrLen(255)]
        public virtual string id
        {
            get
            {
                // *** Start programmer edit section *** (ДирОтдПоРабСКл.id Get start)

                // *** End programmer edit section *** (ДирОтдПоРабСКл.id Get start)
                string result = this.fid;
                // *** Start programmer edit section *** (ДирОтдПоРабСКл.id Get end)

                // *** End programmer edit section *** (ДирОтдПоРабСКл.id Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ДирОтдПоРабСКл.id Set start)

                // *** End programmer edit section *** (ДирОтдПоРабСКл.id Set start)
                this.fid = value;
                // *** Start programmer edit section *** (ДирОтдПоРабСКл.id Set end)

                // *** End programmer edit section *** (ДирОтдПоРабСКл.id Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДирОтдПоРабСКлE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДирОтдПоРабСКлE", typeof(IIS.Kursovaya10.ДирОтдПоРабСКл));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДирОтдПоРабСКлL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДирОтдПоРабСКлL", typeof(IIS.Kursovaya10.ДирОтдПоРабСКл));
                }
            }
        }
    }
